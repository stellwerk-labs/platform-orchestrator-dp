...
func GetJobSpec(ctx context.Context, jobConfig platformorchestratorcp.K8sRunnerJobConfig, externalDataplaneUrl, runnerImage, token, runnerLogsSignedUrl, metadataOutputKey string, d *model.DeploymentSummary) (*v1.JobSpec, error) {
			...
			Containers: []corev1.Container{
				{
					...
					Env: slices.Collect(func(yield func(corev1.EnvVar) bool) {
						for k, v := range runnercommon.GenerateEnvVarsForRun(externalDataplaneUrl, token, runnerLogsSignedUrl, metadataOutputKey, d) {
